...
<div className="row">
  ...
  <div id="bio-wrapper" className="col s7">
    ...
    <ul>
      ...
      <li>🏆 Vivamus scelerisque rutrum sem, pharetra facilisis tellus ullamcorper vitae</li>
      <li>🏆 Duis auctor egestas nisl</li>
      <li>🏆 Duis cursus rutrum tortor et tempor</li>
    </ul>
  </div>
