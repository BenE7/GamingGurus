...
class Faves extends Component {
  render(props) {
    return (
     ...
     {this.props.userinfo.selectedGames.indexOf("Rocket League") > -1 && 
      ...
      {this.props.userinfo.selectedGames.indexOf("Fortnite") > -1 &&
        <div className="col s12 m6">
          <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
      ...
      {this.props.userinfo.selectedGames.indexOf("Player Unknown's Battle Grounds") > -1 &&
        <div className="col s12 m6">
          <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
      ...
      {this.props.userinfo.selectedGames.indexOf("DOTA 2") > -1 &&
        <div className="col s12 m6">
          <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
      ...
      {this.props.userinfo.selectedGames.indexOf("Counter Strike Global Offensive") > -1 &&
        <div className="col s12 m6">
          <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
