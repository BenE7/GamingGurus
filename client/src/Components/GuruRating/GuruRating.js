...
const GuruRating =(props) => {
    let totalRatings =  ( props.userinfo.ratings[0]) ? props.userinfo.ratings[0].totalRatings : ''
    let currentRating = ( props.userinfo.ratings[0]) ? props.userinfo.ratings[0].rating : ''
